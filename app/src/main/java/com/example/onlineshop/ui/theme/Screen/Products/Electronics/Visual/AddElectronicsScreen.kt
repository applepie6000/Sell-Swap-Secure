...
@Composable
fun ElectronicImage(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, quantity:String, price:String) {
    ...
    Column(modifier = modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Column(
            ...
            Button(onClick = {
                ...
                productRepository.UploadElectronics(name, quantity, price,imageUri!!)
                navController.navigate(ROUTE_VIEW_ELECTRONICS)
