...
@Composable
fun AddBoatScreen(navController:NavHostController){
    Scaffold(
        bottomBar = {
            BottomAppBar(
                actions = {
...
@Composable
fun BoatImage(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, quantity:String, price:String) {
    ...
    Column(modifier = modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Column(
            ...
            Button(onClick = {
                ...
                productRepository.UploadBoats(name, quantity, price,imageUri!!)
                navController.navigate(ROUTE_BOAT_VIEW_ADD)
