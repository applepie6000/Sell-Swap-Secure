...
@Composable
fun CarImage(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, quantity:String, price:String) {
    ...
    Column(modifier = modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Column(
            ...
            Button(onClick = {
                ...
                productRepository.UploadCars(name, quantity, price,imageUri!!)
